...
@section('content')
         ...
         <h6 class="content-group text-semibold">
						All products
						<small class="display-block">Basic card using <code>thumbnail</code> component</small>
		</h6>
		@if(session('success'))
        ...
        @endif
					...
					@foreach($products as $product)
						...
						<div class="col-lg-3 col-md-6">
							<div class="thumbnail">
								<div class="product">
									<a href="{{ route('product.details', $product->id) }}"><img src="{{ $product->image ? asset('storage/' . $product->image) : asset('assets/images/placeholder.jpg') }}" style="display: block; margin: 0 auto; padding:10px; width:300px; height:300px; cursor:pointer;" onmouseover="this.style.backgroundColor='black'" onmouseout="this.style.backgroundColor='inherit'"></a>
