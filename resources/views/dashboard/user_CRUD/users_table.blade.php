      ...
      <!-- Bordered striped table -->
					...
					<div class="panel panel-flat" style="background-color: #b2bec3;">
						<div class="panel-heading" style="background-color: #dfe6e9;">
							<h5 class="panel-title"><strong>Users Table</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
									<li><a href="{{ route('create.user.form') }}" class="btn btn-primary"> Create User <i class="fa-solid fa-user-plus"></i></a></li>
			                	</ul>
		                	</div>
						</div>
										...
										<td>
								               <div class="btn-group">
			                    	               ...
			                    	               <ul class="dropdown-menu" style="top:0%; right:80%; padding:0; min-width: 100px; margin:0;">
												       <li><a href="{{ route('show.user',$user->id) }}"><i class="fa-regular fa-eye"></i> Show</a></li>
										               <li><a href="{{ route('edit.user.form',$user->id) }}"><i class="fa-solid fa-user-pen"></i> Edit</a></li>
