				...
				<div class="page-header">
					...
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">Admin Page</span> - Profile</h4>
											...
											<div class="timeline-container">
												...
												<div class="timeline-row">
													<div class="timeline-icon">
														<a href="#"><img src="{{ auth('admin')->user()->image ? asset('storage/' . auth('admin')->user()->image) : asset('assets/images/placeholder.jpg') }}" alt=""></a>
													</div>
													...
													<div class="form-group">
														<div class="row">
															<div class="col-md-6">
																...
																<input type="text" name="first_name" value="{{ auth('admin')->user()->first_name }}" class="form-control">
															</div>
															<div class="col-md-6">
																<label>Last Name</label>
																<input type="text" name="last_name" value="{{ auth('admin')->user()->last_name }}" class="form-control">
															</div>
														</div>
													</div>
                                                    <div class="form-group">
														<div class="row">
															<div class="col-md-6">
																<label>Email</label>
																<input type="text" name="email" value="{{ auth('admin')->user()->email }}" class="form-control">
															</div>
                                                            <div class="col-md-6">
																<label>Phone #</label>
																<input type="text" name="phone" value="{{ auth('admin')->user()->phone }}" class="form-control">
																<span class="help-block">01234567891</span>
							                        		</div>
														</div>
													</div>
                                                    <div class="form-group">
